...
//        pageBackground = a.getColor(R.styleable.LoadingLayout_pageBackground, ConvertUtils.getColor(mContext, R.color.loading_bg));
//        a.recycle();
    }
...
//        errorText = ConvertUtils.findViewById(errorPage, R.id.error_text);
//        emptyText = ConvertUtils.findViewById(emptyPage, R.id.empty_text);
//        networkText = ConvertUtils.findViewById(networkPage, R.id.no_network_text);
//
//        errorImg = ConvertUtils.findViewById(errorPage, R.id.error_img);
//        emptyImg = ConvertUtils.findViewById(emptyPage, R.id.empty_img);
//        networkImg = ConvertUtils.findViewById(networkPage, R.id.no_network_img);
//
//        errorReloadBtn = ConvertUtils.findViewById(errorPage, R.id.error_reload_btn);
//        networkReloadBtn = ConvertUtils.findViewById(networkPage, R.id.no_network_reload_btn);
        ...
        errorText.setTextColor(ConvertUtils.getColor(mContext, mConfig.tipTextColor));
        emptyText.setTextColor(ConvertUtils.getColor(mContext, mConfig.tipTextColor));
        networkText.setTextColor(ConvertUtils.getColor(mContext, mConfig.tipTextColor));
        ...
        errorReloadBtn.setTextColor(ConvertUtils.getColor(mContext, mConfig.buttonTextColor));
        networkReloadBtn.setTextColor(ConvertUtils.getColor(mContext, mConfig.buttonTextColor));

        if (mConfig.buttonHeight != -1) {

//            errorReloadBtn.setHeight(ConvertUtils.dp2px(mConfig.buttonHeight));
//            networkReloadBtn.setHeight(ConvertUtils.dp2px(mConfig.buttonHeight));
        }
        if (mConfig.buttonWidth != -1) {

//            errorReloadBtn.setWidth(ConvertUtils.dp2px(mConfig.buttonWidth));
//            networkReloadBtn.setWidth(ConvertUtils.dp2px(mConfig.buttonWidth));
        }
    ...
    public LoadingLayout setReloadButtonTextColor(@ColorRes int id) {
        ...
        errorReloadBtn.setTextColor(ConvertUtils.getColor(mContext, id));
        networkReloadBtn.setTextSize(ConvertUtils.getColor(mContext, id));
        return this;
    }
    ...
    public LoadingLayout setDefineBackgroundColor(@ColorRes int color) {
        ...
        if (defineLoadingPage == null) {
            loadingPage.setBackgroundColor(ConvertUtils.getColor(mContext, color));
        } else {
            defineLoadingPage.setBackgroundColor(ConvertUtils.getColor(mContext, color));
        }
        errorPage.setBackgroundColor(ConvertUtils.getColor(mContext, color));
        emptyPage.setBackgroundColor(ConvertUtils.getColor(mContext, color));
        networkPage.setBackgroundColor(ConvertUtils.getColor(mContext, color));
        return this;
    }
    ...
    public static class Config {
        ...
        String netwrokStr = "网络信号飞走了";
        String reloadBtnStr = "轻触刷新";
        int emptyImgId = R.drawable.ic_launcher_background;
        int errorImgId = R.drawable.ic_launcher_background;
        int networkImgId = R.drawable.ic_launcher_background;
        int reloadBtnId = R.drawable.ic_launcher_background;
        int tipTextSize = 14;
        int buttonTextSize = 14;
        int tipTextColor = R.color.colorAccent;
        int buttonTextColor = R.color.colorAccent;
        int buttonWidth = -1;
        int buttonHeight = -1;
        int loadingLayoutId = R.layout.activity_main;
