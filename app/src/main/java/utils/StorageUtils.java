 ...
 * <p/>
 * https://github.com/nostra13/Android-Universal-Image-Loader/blob
 * /4c728792d73e964f6d8501f742cda57dd56731c6/library/src/main/java/com/nostra13
 * /universalimageloader/utils/StorageUtils.java
 *
...
public final class StorageUtils {
    ...
    /**
     * Returns specified application cache directory. Cache directory will be created on SD card
     * by defined path if card
     * is mounted and app has appropriate permission. Else - Android defines cache directory on
    ...
    private static File getExternalCacheDir(Context context) {
        ...
        if (!appCacheDir.exists()) {
            ...
            try {
                ...
                Log.i(TAG, "Can't create \".nomedia\" file in application external cache " +
                        "directory");
            }
        }
        return appCacheDir;
